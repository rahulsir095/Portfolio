...
const AboutPage = () => {
   ...
   const fetchData = useCallback(async () => {
      try {
         ...
         const [resumeSnapshot] = await Promise.all([
            getDocs(resumeCollection),
         ]);
         console.log();
         setResume(resumeSnapshot);

         // Store in localStorage
         // localStorage.setItem("resume", JSON.stringify(resumeSnapshot));
      } catch (error) {
            ...
            <div className="flex flex-col-reverse lg:grid lg:grid-cols-2 gap-10 lg:gap-16 items-center">
               <div className="space-y-6 text-center lg:text-left">
                  ...
                  <div className="flex flex-col lg:flex-row items-center lg:items-start gap-4 lg:gap-4 lg:px-0 w-full">
                     <a
                        href="https://ik.imagekit.io/ay6bdp4tm/Rahul%20Kumar%20Full-Stack.pdf"
